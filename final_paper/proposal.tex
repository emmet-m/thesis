...
analyse all the types in the program at once, and simpler constraint generation and solving phases.
...
parameters that would currently appear in a non-strictly positive position $\mathcal{S}$.
