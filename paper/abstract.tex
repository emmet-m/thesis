...
The main task of this project is to add a restricted form of recursion to Cogent while keeping the language total. This would enable defining more data-types as well as iterators over these data-types directly in Cogent rather than resorting to C.