...
that there is no general algorithm to prove such a thing}\liam{primitive recursion is the solvable case. General termination is not provable.}, and thus can only cover more and more
...
it here?}
\liam{Feel free to talk about it here}
