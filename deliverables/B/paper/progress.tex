...
\begin{figure}
    ...
    \begin{align*}
        \infer{
            \textbf{mu } t\; \{ \overline{f_i : \tau_i} \} = \textbf{mu } t'\; \{ \overline{f_i : \rho_i} \}
        }{
            \textbf{mu } t\; \{ \overline{f_i : \tau_i[\sfrac{ \textbf{mu } t \{\overline{f_i : \tau_i} \}}{t}]} \} = \textbf{mu } t\; \{ \overline{f_i : \rho_i[\sfrac{ \textbf{mu } t' \{\overline{f_i : \rho_i} \}}{t'}]} \}
        }
    \end{align*}
    \caption{The method for proving type equality for putting, by replacing recursive parameters with the 
             definition of the recursive record they reference}
...
\begin{figure}
    ...
    \end{align*}
    \caption{The method for proving type equality for putting, by replacing a nested recursive record
             with a recursive parameter that references the parent record}
