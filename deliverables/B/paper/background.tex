...
in their expressiveness and are a subset of all computable functions, so we cannot rely on them for the general case.
...
or non-strictly positive types introduce logical inconsistencies, something that is unacceptable for a theorem prover.
