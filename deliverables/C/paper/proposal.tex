    ...
    \[
        \infer[\textsc{\footnotesize T-Case}]{
            E_1; G_1 \vdash \textsf{case } e_1 \textsf{ of } \kappa\; x.\; e_2\; 
                \textsf{else} \kappa y.\; e_3
                \rightsquigarrow G_3\; |\; E_1\; |\; C_1 \cup C_2
        }{
            \begin{array}{c}
                \alpha, \beta\; \textsf{fresh}
                \hspace{1em}
                E_1;\alpha \tlt \beta, \alpha \teq \textsf{get}(E_1, e_2), 
                    \beta \teq \textsf{get}(E_1, e_1)\; G_1 \vdash e_1 
                    \rightsquigarrow G_2\; |\; E_2\; |\; C_1 \\[5pt]
                E_1; G_2 \vdash e_2 \rightsquigarrow G_3\; |\; E_3\; |\; C_2
            \end{array}
        }
    ...
    \[
        \infer[\textsc{\footnotesize T-FApp}]{
            E_1; G_1 \vdash e_1\; e_2
                \rightsquigarrow G_3\; |\; E_1\; |\; C_1 \cup C_2 \cup \{e_2\}
        }{
...
Additionally, an alternative to integer linear programming is to use a directed graph to construct
