    ...
    \begin{align*}
        \infer[\textsc{\footnotesize{Put}}]{
            ...
            \begin{array}{c}
                ...
                \vspace{0.5em} \\
                \mu \textit{ s } \textbf{UnboxedNotRecursive}
            \end{array}
        }
    \end{align*}
...
\todo{I'm starting to think that \textbf{UnboxedNotRecurse} doesn't belong here
and only belongs in the constraint generation, i.e. the typing rules should
remain unchanged. Yes?}

Next, we modify the \textsc{CG-Take}, \textsc{CG-Put} and \textsc{CG-Member} for constraint generation,
...
\todo{Discuss primitive recursion}